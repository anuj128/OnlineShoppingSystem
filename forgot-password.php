...
$query=mysqli_query($con,"SELECT * FROM user_info WHERE email='$email' and mobile='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="forgot-password.php";
mysqli_query($con,"update user_info set password='$password' WHERE email='$email' and mobile='$contact' ");
